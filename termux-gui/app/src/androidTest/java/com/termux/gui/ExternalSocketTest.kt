...
class ExternalSocketTest {
    companion object {
        const val sockname = "com.termux test"
        const val esockname = "com.termux teste"
    }
    ...
    fun nontermuxSocketFail() {
        ...
        starttest.component = ComponentName.unflattenFromString("com.termux.externaltest/.RestartReceiver")
        c.sendBroadcast(starttest)
        starttest.component = ComponentName.unflattenFromString("com.termux.externaltest/.TestConnectReceiver")
        val extras = Bundle()
        ...
        val i = Intent()
        i.component = ComponentName.unflattenFromString("com.termux/.GUIReceiver")

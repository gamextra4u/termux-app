...
Java_com.termux_hbuffers_HBuffers_00024Companion_nativeHardwareBufferToEGLImageKHR(JNIEnv *env,
                                                                                       jobject thiz,
                                                                                       jlong dispJ,
                                                                                       jobject bJ) {
...
Java_com.termux_hbuffers_HBuffers_00024Companion_sendHardwareBuffer(JNIEnv *env, jobject thiz,
                                                                        jint fd, jobject bJ) {
    AHardwareBuffer* b = AHardwareBuffer_fromHardwareBuffer(env, bJ);
